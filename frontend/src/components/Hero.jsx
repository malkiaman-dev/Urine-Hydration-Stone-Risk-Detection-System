...
const Hero = () => {
  return (
    <section id="home" className="relative overflow-hidden pb-20 pt-32 lg:pb-28">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-medical-subtext sm:text-lg lg:mx-0">
                Upload a urine sample image and receive AI-assisted screening insights
                for hydration status, stone risk probability, and recommended next actions.
              </p>
              ...
              <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3 lg:text-left">
                <div className="flex items-center justify-center gap-2 lg:justify-start">
                  <ShieldCheck className="h-4 w-4 text-primary" />
                  <span className="text-sm font-semibold text-medical-subtext">
                    Secure Workflow
                  </span>
                </div>
              ...
              <div className="card-premium overflow-hidden rounded-3xl border border-primary/10">
                ...
                <div className="space-y-5 p-6">
                  <div className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
                    <p className="text-xs font-bold uppercase tracking-wider text-medical-subtext">
                      Model Outputs
                    </p>
                  ...
                  <div className="rounded-2xl border border-secondary/20 bg-secondary/5 p-4">
                    ...
                    <p className="mt-2 text-sm font-medium text-medical-text">
                      Increase water intake and continue periodic screening to reduce
                      moderate stone risk patterns.
                    </p>
                  </div>
                </div>
              </div>
